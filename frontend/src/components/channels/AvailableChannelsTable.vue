<template>
  <div class="card overflow-hidden">
    <table class="w-full table-fixed border-collapse text-sm">
      ...
      <!-- 每个渠道一�?tbody：首�?td rowspan 渠道名，后续行只渲染其余三列�?           tbody 之间强分隔线表达"渠道边界"，tbody 内部用淡分隔线区分平台�?-->
      <tbody
        v-else
      ...
      >
        ...
        >
          ...
          <!-- 分组：专属分组在前（紫色 shield 行），公开分组在后（灰�?globe 行）�?-->
          <td class="align-top px-4 py-3">
